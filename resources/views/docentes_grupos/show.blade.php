...
@section('content')
    <h1>Ver grupo de docente</h1>
        @csrf
    <script>console.log(@json($docenteGrupo));</script>
    <div class="row">
        <div class="col-md-6">
        <label for="docente_nombre" class="form-label">Docente</label>
            <input type="text" class="form-control" id="docente_nombre" name="docente_nombre"
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="{{ route('docentes_grupos.index') }}" class="btn btn-secondary">Volver</a>
        </div>
    </div>
@endsection