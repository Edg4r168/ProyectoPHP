...
Route::group(['prefix' => 'estudiantes', 'middleware' => 'auth_estudiantes'], function () {
    Route::get('/home', [EstudianteController::class, 'home'])->name('estudiantes.home');
    Route::get('/registrarAsistencia', [EstudianteController::class, 'registrarAsistencia'])->name('estudiantes.registrarAsistencia');
});
...
Route::get('/estudiantes/login', [EstudianteController::class, 'loginForm'])->name('estudiantes.loginForm');
